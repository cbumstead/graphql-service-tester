...
function runGraphQLTests(server, headers, progressCallback) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield p_iteration_1.forEachSeries(orderedQueries, (item) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield graphqlClient_1.queryClient(server, item.pluggedInQuery, item.type, headers);
                ...
                if (!report.run.meetsSLA)
                    logErrorToReport(report, `SLA response time: ${(_a = report.query.sla) === null || _a === void 0 ? void 0 : _a.responseTime}ms exceeded by ${report.run.ms}ms`);
